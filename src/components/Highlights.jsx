...
const Highlights = ({ stats }) => {
  ...
  return (
    ...
    items-center text-transform scale-100 hover:scale-110  transition-transform duration-300 ease-in-out cursor-pointer"
    >
      <h2 className="textsm mt-2">{stats.title}</h2>
      <div className="mt-2">
